...
import com.stuff.stuffmod.HyperSpaceTeleporter;
...
public class HyperSpacePortal extends BlockPortal
{
	public HyperSpacePortal()
	{
		super();
		setBlockName("HyperSpacePortal");
	...
	public boolean func_150000_e(World par1World, int par2, int par3, int par4)
	{
		...
		else
		{
			...
			for (l = 0; l < 2; ++l)
			{
				for (i1 = 0; i1 < 3; ++i1)
				{
					par1World.setBlock(par2 + b0 * l, par3 + i1, par4 + b1 * l, Stuff.HyperSpacePortal, 0, 2);
				}
			}
