...
public class WorldGenFireAltar extends WorldGenerator implements IWorldGenerator
{
	...
	public boolean generate(World world, Random rand, int x, int y, int z) {
		...
		this.setBlock(world, x + 0, y + 0, z + 0, Blocks.nether_brick, 0);
		this.setBlock(world, x + 0, y + 0, z + 1, Blocks.nether_brick, 0);
		this.setBlock(world, x + 0, y + 0, z + 2, Blocks.nether_brick, 0);
		this.setBlock(world, x + 0, y + 0, z + 3, Blocks.nether_brick, 0);
		this.setBlock(world, x + 0, y + 0, z + 4, Blocks.nether_brick, 0);
		this.setBlock(world, x + 0, y + 1, z + 0, Blocks.nether_brick, 0);
		...
		this.setBlock(world, x + 0, y + 1, z + 4, Blocks.nether_brick, 0);
		this.setBlock(world, x + 0, y + 2, z + 0, Blocks.nether_brick, 0);
		...
		this.setBlock(world, x + 0, y + 2, z + 4, Blocks.nether_brick, 0);
		this.setBlock(world, x + 0, y + 3, z + 0, Blocks.nether_brick, 0);
		...
		this.setBlock(world, x + 0, y + 3, z + 4, Blocks.nether_brick, 0);
		this.setBlock(world, x + 0, y + 4, z + 0, Blocks.skull, 1);
		...
		this.setBlock(world, x + 0, y + 4, z + 4, Blocks.skull, 1);
		this.setBlock(world, x + 1, y + 0, z + 0, Blocks.nether_brick, 0);
		this.setBlock(world, x + 1, y + 0, z + 1, Blocks.nether_brick, 0);
		this.setBlock(world, x + 1, y + 0, z + 2, Stuff.crystallizedFire, 0);
		this.setBlock(world, x + 1, y + 0, z + 3, Blocks.nether_brick, 0);
		this.setBlock(world, x + 1, y + 0, z + 4, Blocks.nether_brick, 0);
		...
		this.setBlock(world, x + 2, y + 0, z + 0, Blocks.nether_brick, 0);
		this.setBlock(world, x + 2, y + 0, z + 1, Stuff.crystallizedFire, 0);
		this.setBlock(world, x + 2, y + 0, z + 2, Blocks.nether_brick, 0);
		this.setBlock(world, x + 2, y + 0, z + 3, Stuff.crystallizedFire, 0);
		this.setBlock(world, x + 2, y + 0, z + 4, Blocks.nether_brick, 0);
		this.setBlock(world, x + 2, y + 1, z + 0, Blocks.air, 0);
		this.setBlock(world, x + 2, y + 1, z + 1, Blocks.air, 0);
		this.setBlock(world, x + 2, y + 1, z + 2, Blocks.nether_brick, 0);
		...
		this.setBlock(world, x + 2, y + 2, z + 2, Blocks.nether_brick, 0);
		...
		this.setBlock(world, x + 3, y + 0, z + 0, Blocks.nether_brick, 0);
		this.setBlock(world, x + 3, y + 0, z + 1, Blocks.nether_brick, 0);
		this.setBlock(world, x + 3, y + 0, z + 2, Stuff.crystallizedFire, 0);
		this.setBlock(world, x + 3, y + 0, z + 3, Blocks.nether_brick, 0);
		this.setBlock(world, x + 3, y + 0, z + 4, Blocks.nether_brick, 0);
		...
		this.setBlock(world, x + 4, y + 0, z + 0, Blocks.nether_brick, 0);
		this.setBlock(world, x + 4, y + 0, z + 1, Blocks.nether_brick, 0);
		this.setBlock(world, x + 4, y + 0, z + 2, Blocks.nether_brick, 0);
		this.setBlock(world, x + 4, y + 0, z + 3, Blocks.nether_brick, 0);
		this.setBlock(world, x + 4, y + 0, z + 4, Blocks.nether_brick, 0);
		this.setBlock(world, x + 4, y + 1, z + 0, Blocks.nether_brick, 0);
		...
		this.setBlock(world, x + 4, y + 1, z + 4, Blocks.nether_brick, 0);
		this.setBlock(world, x + 4, y + 2, z + 0, Blocks.nether_brick, 0);
		...
		this.setBlock(world, x + 4, y + 2, z + 4, Blocks.nether_brick, 0);
		this.setBlock(world, x + 4, y + 3, z + 0, Blocks.nether_brick, 0);
		...
		this.setBlock(world, x + 4, y + 3, z + 4, Blocks.nether_brick, 0);
		this.setBlock(world, x + 4, y + 4, z + 0, Blocks.skull, 1);
		...
		this.setBlock(world, x + 4, y + 4, z + 4, Blocks.skull, 1);
